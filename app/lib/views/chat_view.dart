              ...
              child: Column(
                children: [
                  ...
                  Container(
                    ...
                    child: Row(
                      children: [
                        const Icon(Icons.chat_bubble_outline_rounded, color: Color(0xFF89B4FA)),
                        const SizedBox(width: 10),
                        Text(
                          "Chatting with ${_activeContact?.username ?? 'Select Contact'}",
                                ...
                                itemBuilder: (ctx, i) {
                                  ...
                                  return Align(
                                    ...
                                    child: Container(
                                      ...
                                      decoration: BoxDecoration(
                                        color: isMe ? const Color(0xFF89B4FA).withOpacity(0.2) : const Color(0xFF313244),
                        ...
                        Expanded(
                          child: TextField(
                            ...
                            decoration: InputDecoration(
                              ...
                              hintStyle: GoogleFonts.inter(color: const Color(0xFFA6ADC8)),
                              filled: true,
